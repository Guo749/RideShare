  ...
  <el-container style="border: 1px solid #eee; height: 100%">
    ...
    <el-container>
      ...
      <el-main style="height: 100%">
        <div style="font-size: 20px" v-if="hitOwn">All Rides I Owned</div>
        <div style="font-size: 20px" v-if="hitDriver">All Rides As a Driver Owned</div>
        <div style="font-size: 20px" v-if="hitShare">All Rides I Shared</div>
...
export default {
  ...
  mounted() {
    this.hitOwn    = this.$store.state.hitOwn;
    this.hitShare  = this.$store.state.hitShare;
    this.hitDriver = this.$store.state.hitDriver;  
