  ...
  <el-container style="border: 1px solid #eee; height: 100%">
    ...
    <el-container>
      ...
      <el-main style="height: 100%">
        <div style="font-size: 20px">Available Rides List</div>
...
<script>
import { loadOpenRide} from "../api/api.js";
  ...
  computed: {
    tables() {
      ...
      return _.filter(this.tableData, (ride) => {
        console.log(ride.numPeople)
        console.log(this.filterCondition.numPeople)
        console.log(ride.numPeople == this.filterCondition.numPeople)
        return (
